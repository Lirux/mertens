...
return new class extends Migration
{
     ...
     */
    private function assetSchema(array $statuses, bool $requireApiFields): array
    {
        $required = [
            'asset_number',
            'name',
        ...
        if ($requireApiFields) {
            $required = [...$required, 'acquisition_value', 'currency'];
        }
